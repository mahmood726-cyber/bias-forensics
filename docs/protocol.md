        # Bias Forensics: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/bias-forensics.git

        ## Objective

        Bias Forensics applies eight publication bias detection methods across 307 Cochrane systematic reviews, providing a landscape analysis of small-study effects in clinical evidence, targeting RSM.
        ...
        - Code: https://github.com/mahmood726-cyber/bias-forensics.git
        - Dashboard: https://mahmood726-cyber.github.io/bias-forensics/
